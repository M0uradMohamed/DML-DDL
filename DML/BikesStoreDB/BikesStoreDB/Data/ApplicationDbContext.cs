...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E27CD8F511A");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4DB926C81");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB8502E1158F");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__465962292A1E8A34");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D4FC471565");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF590BCCFB9");

            entity.ToTable("products", "production");

            entity.HasIndex(e => e.ProductName, "products");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C60CC7561");

            entity.ToTable("staffs", "sales");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E61648AE44C9D").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D368012F3C");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30CB7E9E487");
